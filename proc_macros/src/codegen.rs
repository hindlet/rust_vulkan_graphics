...
pub(super) fn reflect(
    ...
    let spirv_version = {
        ...
        quote! {
            ::rust_vulkan_graphics::all_vulkano::Version {
                major: #major,
                minor: #minor,
                patch: #patch,
            }
    ...
    let spirv_capabilities = reflect::spirv_capabilities(&shader.spirv).map(|capability| {
        ...
        quote! { &::rust_vulkan_graphics::all_vulkano::shader::spirv::Capability::#name }
    });
    ...
    let shader_code = quote! {
        ...
        #[inline]
        pub fn #load_name(
            device: ::std::sync::Arc<::rust_vulkan_graphics::all_vulkano::device::Device>,
        ) -> ::std::result::Result<
            ::std::sync::Arc<::rust_vulkan_graphics::all_vulkano::shader::ShaderModule>,
            ::rust_vulkan_graphics::all_vulkano::shader::ShaderCreationError,
        > {
            ...
            unsafe {
                ::rust_vulkan_graphics::all_vulkano::shader::ShaderModule::from_words_with_data(
                    device,
                    WORDS,
                    #spirv_version,
                    [ #( #spirv_capabilities ),* ],
